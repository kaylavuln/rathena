macro( INSTALL_TEMPLATE _SRC _DST )
  set( SRC "C:/Users/masva/Downloads/RO Project/Server.Classic/rathena/${_SRC}" )
  set( DST "${CMAKE_INSTALL_PREFIX}/${_DST}" )
  if( EXISTS "${DST}" )
    message( "-- Already exists: ${DST}" )
  else()
    message( "-- Installing template: ${DST}" )
    execute_process( COMMAND "C:/Program Files/Microsoft Visual Studio/18/Insiders/Common7/IDE/CommonExtensions/Microsoft/CMake/CMake/bin/cmake.exe" -E copy "${SRC}" "${DST}" )
  endif()
endmacro()
